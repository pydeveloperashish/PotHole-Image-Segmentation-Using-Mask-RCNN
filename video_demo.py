...
#'C:/Python37/Projects/models/research/object_detection/test_videos/THE_HIMALAYAN_HUSKY.mp4'
width, height = stream.get(cv2.CAP_PROP_FRAME_WIDTH), stream.get(cv2.CAP_PROP_FRAME_HEIGHT)
out = cv2.VideoWriter('C:/Python37/Projects/models/research/object_detection/test_videos/2PotHoles20FPS.avi',cv2.VideoWriter_fourcc('M','J','P','G'), 30, (int(width),int(height)))
while True:
