...
COCO_MODEL_PATH = r'C:\Python37\Projects\models\research\object_detection\mask_rcnn_inception_v2_coco_2018_01_28\Mask_RCNN-master\mask_rcnn_balloon_0030.h5'
...
r = results[0]
print("test1")
ac=display_instances(image, r['rois'], r['masks'], r['class_ids'], 
